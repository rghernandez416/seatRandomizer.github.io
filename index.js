...
function displayShuffle() {
    ...
    let array = ["Gabe", "Gisselle", "Mary", "Matthew", "Janie", "Allie", "Kassy", "Lanna"];
    ...
    var seat6 = document.getElementById("s5").innerHTML = shuffleResult[5];
    var seat7 = document.getElementById("s6").innerHTML = shuffleResult[6];
    var seat8 = document.getElementById("s7").innerHTML = shuffleResult[7];
